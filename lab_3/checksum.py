...
def serialize_result(variant: int, checksum: str, path_to_result: str) -> None:
    """
    ...
    :param path_to_result: путь для сохранения результата
    """
    data = {
        "variant": variant,
        "checksum": checksum
    ...
    try:
        ...
        print(f'Error in writing the data to file: {e}')
